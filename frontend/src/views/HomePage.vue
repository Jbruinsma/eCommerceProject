  ...
  <div class="home-container">
    <nav class="navbar">
      ...
      <div class="nav-icons">
        ...
        <svg @click="router.push('/login')" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="account-icon">
...
const featuredProducts = ref([
  { id: 1, name: 'Air Runner "Graphite"', price: 250, imageUrl: 'https://placehold.co/400x300/1a1a1a/ffffff?text=Sneaker+1' },
