<template>
  ...
  >
    ...
    <p v-if="brandName" class="product-brand">{{ brandName }}</p>
...
.product-price { color: #3c862a; font-family: Bodoni Moda, BlinkMacSystemFont, serif; font-size: 1.2rem; margin-top: 0.25rem; }
</style>
